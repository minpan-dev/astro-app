...
timeline
    title 前端技术演进时间轴
    1990s : 静态网页时代 : HTML + 简单的 CSS <br> JSP / PHP 服务端渲染
    2000s : 动态交互时代 : JavaScript + DOM API <br> AJAX 的诞生（Web 2.0）
    2006 : 库的时代 : jQuery（抹平浏览器差异，简化 DOM 操作）
    2009 : 工具链基石 : Node.js 诞生，npm 生态启动
    2010 : MVC/MVVM 探索期 : AngularJS, Backbone.js（前端工程化启蒙）
    2013-2014 : 组件化与虚拟 DOM : React（2013）, Vue.js（2014）声明式 UI，状态驱动
    2016+ : 元框架与全栈前端 : Next.js, Nuxt.js（SSR, SSG，关注性能与 SEO）
    2017-2020 : 工程化成熟期 : TypeScript 普及，Webpack → Vite，工具链质变
    2020+ : 性能极致探索 : Svelte, Astro, Qwik（无虚拟 DOM，孤岛架构，可恢复性）
```
